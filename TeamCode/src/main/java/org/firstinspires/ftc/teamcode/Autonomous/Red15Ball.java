...
public class Red15Ball extends OpMode{
    ...
    private final Pose shootPoseEX = new Pose(94.83926031294453, 91.76671408250354, Math.toRadians(39));
    private final Pose preHitLever = new Pose(120, 70.57972350230413, Math.toRadians(0));
    private final Pose hitLeverPose = new Pose(127, 71.37972350230413, Math.toRadians(0));
    ...
    private final Pose rowTwoEnd = new Pose(130.54608294930875, 56.39631336405527, Math.toRadians(0));
    ...
    private void shootEX() {
        Shooter.setShooterPower(SHOOT_SPEED, .35, turretRotator);
