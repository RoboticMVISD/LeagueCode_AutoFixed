...
public class PedroMovementBlue {
    private Follower follower;
    private final Pose startingPose = new Pose(44.5, 63.82047685834502, Math.toRadians(270));
    ...
    //------- Parking Path ---------- //
    private final Pose parkPose = new Pose(106.77073170731707, 33.482926829268294, Math.toRadians(0));
